...
- (IBAction)accessSignUp:(id)sender {
    ...
    /*
     4개 필드 빈칸 여부
     */
    if([self.email.text isEqualToString:@""] || [self.userID.text isEqualToString:@""] || [self.passwordRewrite.text isEqualToString:@""] || [self.passwordRewrite.text isEqualToString:@""]){
